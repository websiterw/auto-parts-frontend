      ...
      <form id="login-form" style="background:#fff; border-radius:32px 32px 0 0; border-top:4px solid #dc2626; padding:24px 24px 32px;">
        ...
        <div style="display:flex; flex-direction:column; gap:16px;">
          <div style="display:flex; align-items:center; border:2px solid #2E6F40; border-radius:12px; padding:12px 16px;">
            <input id="login-account" type="text" placeholder="Account number" style="flex:1; outline:none; border:none; background:transparent; color:#2E6F40; font-size:16px;">
          </div>
          <div style="display:flex; align-items:center; border:2px solid #2E6F40; border-radius:12px; padding:12px 16px;">
            <input id="login-password" type="password" placeholder="Password" style="flex:1; outline:none; border:none; background:transparent; color:#2E6F40; font-size:16px;">
          </div>
        </div>
