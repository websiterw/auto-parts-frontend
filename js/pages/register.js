...
export function renderRegister() {
  ...
  app.innerHTML = `
    <div style="position:relative; width:100%; height:280px; background: #2E6F40;">
      <img src="assets/images/register-banner.png" alt="Green Basket" style="width:100%; height:100%; object-fit:cover;" onerror="this.style.display='none'">
    ...
    <div style="padding:0 16px; margin-top:-24px;">
      <form id="register-form" style="background:#fff; border-radius:32px 32px 0 0; border-top:4px solid #dc2626; padding:24px 24px 32px;">
        ...
        <div style="display:flex; flex-direction:column; gap:16px;">
          <div style="display:flex; align-items:center; border:2px solid #2E6F40; border-radius:12px; padding:12px 16px;">
            <input id="reg-account" type="text" placeholder="Account number" style="flex:1; outline:none; border:none; background:transparent; color:#2E6F40; font-size:16px;">
          </div>
          <div style="display:flex; align-items:center; border:2px solid #2E6F40; border-radius:12px; padding:12px 16px;">
            <input id="reg-password" type="password" placeholder="Enter password" style="flex:1; outline:none; border:none; background:transparent; color:#2E6F40; font-size:16px;">
          </div>
          <div style="display:flex; align-items:center; border:2px solid #2E6F40; border-radius:12px; padding:12px 16px;">
            <input id="reg-password2" type="password" placeholder="Re-enter password" style="flex:1; outline:none; border:none; background:transparent; color:#2E6F40; font-size:16px;">
          </div>
          <div style="display:flex; align-items:center; border:2px solid #2E6F40; border-radius:12px; padding:12px 16px;">
            <input id="reg-invite" type="text" placeholder="Invitation code (optional)" value="${referralCode}" style="flex:1; outline:none; border:none; background:transparent; color:#2E6F40; font-size:16px;">
          </div>
        </div>
