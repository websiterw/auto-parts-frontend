  ...
  app.innerHTML = `
    ...
    <div style="padding:0 16px; margin-top:-20px;">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px; margin-bottom:16px;">
        ...
        <button class="btn" onclick="window.location.hash='team'" style="background:#22c55e; color:#fff; border:none; border-radius:30px; padding:10px; font-weight:700; cursor:pointer;">My team</button>
      ...
      <div style="background:#fff; border-radius:16px; border:2px solid #22c55e; overflow:hidden; margin-bottom:16px;">
        ${[
          ...
          <div onclick="${item.action}" style="display:flex; align-items:center; gap:12px; padding:14px 16px; border-bottom:1px solid #f0f0f0; cursor:pointer; transition:background 0.1s;" onmouseover="this.style.background='#f5f5f5'" onmouseout="this.style.background='#fff'">
            ...
            <span style="flex:1; font-size:14px; font-weight:600; color:#16a34a;">${item.label}</span>
      ...
      <div style="background:#fff; border-radius:16px; padding:16px; border:2px solid #22c55e; margin-bottom:16px;">
        ...
        <div style="display:flex; gap:8px;">
          ...
          <button id="gift-redeem" style="background:#22c55e; color:#fff; border:none; border-radius:8px; padding:8px 16px; font-weight:700; cursor:pointer;">Redeem</button>
        </div>
      </div>

      <div style="background:#fff; border-radius:16px; padding:16px; border:2px solid #22c55e; margin-bottom:16px;">
        <p style="font-weight:900; color:#16a34a; margin-bottom:8px;">My orders</p>
