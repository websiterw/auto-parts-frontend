export function renderHome() {
  ...
  // Dummy transaction data (will come from backend)
  const transactions = [
  ...
  app.innerHTML = `
    <div style="padding: 12px 0 8px;">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center;">
          <div style="display:flex; align-items:center; gap:8px;">
            ...
            <div>
              ...
              <p style="font-size:26px; font-weight:700;">RWF ${user.balance?.toFixed(2) || '0.00'}</p>
            </div>
          </div>
          <div style="display:flex; align-items:center; gap:8px;">
            ...
            <div style="text-align:right;">
              ...
              <p style="font-size:20px; font-weight:600; color:#4caf50;">RWF ${user.cumulativeIncome?.toFixed(2) || '0.00'}</p>
            </div>
          </div>
        </div>
        <!-- Four action buttons -->
      ...
      <!-- Transaction History (black cards) -->
  ...
  // Show the launch notification (every time, no session check)
...
// ----- Launch Notification (always shows) -----
function showLaunchNotification() {
  ...
  // OK button → close only (no session tracking)
