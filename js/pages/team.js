...
export async function renderTeam() {
  ...
  app.innerHTML = `
    <div style="position:relative; width:100%; height:100px; background: #2E6F40;">
    ...
    <div style="padding:0 16px; margin-top:100px;">
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px; margin-bottom:16px;">
        <div style="background:#fff; border-radius:16px; padding:16px; border:2px solid #2E6F40; text-align:center;">
      ...
      <div style="background:#fff; border-radius:16px; padding:16px; border:2px solid #2E6F40; margin-bottom:16px;">
        <p style="font-weight:900; color:#2E6F40;">My invitation code</p>
        <p style="font-size:24px; font-weight:900; letter-spacing:2px; color:#dc2626;">${referralCode || '------'}</p>
        <p style="font-size:12px; word-break:break-all; margin-top:8px; color:#2E6F40;">${inviteLink}</p>
        <button onclick="navigator.clipboard.writeText('${inviteLink}'); window.toastSuccess('Link copied!')" style="width:100%; background:#2E6F40; color:#fff; border:none; border-radius:30px; padding:10px; font-weight:700; cursor:pointer; margin-top:8px;">Copy invitation link</button>
      </div>
      <div style="background:#fff; border-radius:16px; padding:16px; border:2px solid #2E6F40;">
        <p style="font-weight:900; margin-bottom:8px; color:#2E6F40;">How the team works</p>
        <ol style="font-size:12px; color:#2E6F40; list-style-position:inside; padding-left:0;">
